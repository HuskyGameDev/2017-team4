...
public class ShopManager : MonoBehaviour
{
	...
	public Text forceDisplayText;
	public Text resDisplayText;
	public Text dexDisplayText;
	...
	void Start ()
	{
		...
		forceDisplayText.text = "Force: "+playerStats.GetForceStat ().ToString();
		resDisplayText.text = "Res: "+playerStats.GetResistanceStat ().ToString();
		dexDisplayText.text = "Dex: "+playerStats.GetDexterityStat ().ToString();
	}
